...
The central black hole acts directly on gas as well as stars. Weak nuclear viscosity removes angular momentum across the inner disk while a compact low-angular-momentum sink accretes slowly, allowing stable nuclear rings to remain visible while feeding the hole. Sustained feeding after at least 50% growth can ignite a brief serialized quasar episode. A pulse train strongly accelerates and irradiates broad gas cones along its seed-stable bipolar axis, visibly redistributing the host and feeding the existing galactic fountain without bypassing the baryon or metal ledgers. See [quasar-feedback.md](quasar-feedback.md).
